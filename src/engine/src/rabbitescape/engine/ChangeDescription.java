...
public class ChangeDescription
{
    public enum State
    {
        ...
        RABBIT_JUMPING_LEFT,
        RABBIT_JUMPING_RIGHT,
        RABBIT_JUMPING_ON_DOWN_SLOPE_RIGHT,
        RABBIT_JUMPING_ON_DOWN_SLOPE_LEFT,
        RABBIT_JUMPING_ON_UP_SLOPE_RIGHT,
        RABBIT_JUMPING_ON_UP_SLOPE_LEFT,
